...
(defvar doom-themes-base-faces
  '((bold        :weight 'bold :foreground (if bold 'unspecified base8))
    ...
    ;;;; slack
    (slack-new-message-marker-face :foreground red :weight 'bold :height 0.8)
    (slack-button-block-element-face :foreground dark-cyan :box `(:line-width 1 :style released-button))
    (slack-button-danger-block-element-face :foreground red :inherit 'slack-button-block-element-face)
    (slack-button-primary-block-element-face :foreground green :inherit 'slack-button-block-element-face)
    (slack-select-block-element-face :foreground dark-cyan :inherit 'slack-button-block-element-face)
    (slack-overflow-block-element-face :foreground dark-cyan :inherit 'slack-button-block-element-face)
    (slack-date-picker-block-element-face :foreground dark-cyan  :inherit 'slack-button-block-element-face)
    ;; (slack-room-info-title-face)
    (slack-room-info-title-room-name-face :foreground orange)
    ;; (slack-room-info-section-title-face)
    ;; (slack-room-info-section-label-face)
    ;; (slack-message-action-face)
    (slack-message-attachment-preview-header-face :foreground dark-cyan :height 1.2 :weight 'bold)
    ...
    (slack-mrkdwn-list-face     :foreground comments)
    (slack-modeline-has-unreads-face :foreground magenta :weight 'bold)
    (slack-modeline-thread-has-unreads-face :foreground magenta :weight 'bold)
    (slack-modeline-channel-has-unreads-face :foreground magenta :weight 'bold)
    (slack-user-dnd-face :foreground dark-cyan :weight 'bold)
    (slack-user-active-face :foreground dark-cyan :weight 'bold)
    (slack-user-profile-header-face :foreground orange :height 1.5 :weight 'bold)
    (slack-user-profile-property-name-face)
    ;; (slack-profile-image-face)
    ;; (slack-message-output-text)
    (slack-message-output-header :foreground orange :height 1.0 :underline t :weight 'bold)
    (slack-message-output-reaction :box '(:line-width 1 :style none))
    ;; My custom one
    (slack-message-output-reaction-pressed :background (doom-blend highlight bg 0.4) :box `(:line-width 1  :color ,highlight))
    ;; (slack-message-deleted-face)
    ;; (slack-attachment-header)
    ;; (slack-attachment-footer)
    ;; (slack-attachment-pad)
    ;; (slack-attachment-field-title)
    (slack-channel-button-face :foreground cyan :underline t)
    (slack-message-mention-face  :background (doom-blend highlight bg 0.2) :foreground highlight)
    (slack-message-mention-me-face :background (doom-blend yellow bg 0.2) :foreground highlight)
    (slack-message-mention-keyword-face :background (doom-blend orange bg 0.2) :weight 'bold)
    (slack-preview-face         :inherit 'org-block)
    ...
    (slack-dialog-submit-button-face :foreground dark-cyan :box `(:line-width 1 :style released-button))
    ;; (slack-dialog-cancel-button-face)
    (slack-message-action-primary-face :foreground dark-cyan :box `(:line-width 1 :style released-button))
    (slack-message-action-danger-face :foreground red :box `(:line-width 1 :style released-button))
    ;;;; smart-mode-line
